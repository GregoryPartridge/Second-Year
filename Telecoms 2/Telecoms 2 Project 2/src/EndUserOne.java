...
public class EndUserOne extends Node implements Runnable {

	private Terminal terminal;

	EndUserOne(Terminal terminal, int port) {
		try {
	...
	public void run() {
		while (true) {
			...
			sendMessage(input, CONSTANT.STARTROUTER);
		}
	}
	...
	public static void main(String[] args) 
	{
		try
    	{
    		Terminal terminal = new Terminal("End User One:");
    		(new EndUserTwo(terminal, CONSTANT.STARTENDUSERONE)).run();
