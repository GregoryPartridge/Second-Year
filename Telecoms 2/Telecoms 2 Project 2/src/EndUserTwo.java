...
public class EndUserTwo extends Node implements Runnable {

	private Terminal terminal;

	EndUserTwo(Terminal terminal, int port) {
		try {
	...
	public static void main(String[] args) 
	{
		try
    	{
    		Terminal terminal = new Terminal("End User Two:");
    		(new EndUserTwo(terminal, CONSTANT.STARTENDUSERTWO)).run();
