...
class Collinear
{
 ...
 // ----------------------------------------------------------
     ...
     *
     *  Explanation: 2 linear for loops, can ignore binary search as you ussualy discard lower terms
     *
     *
     */
    ...
    static int countCollinearFast(int[] a1, int[] a2, int[] a3)
    {
        ...
        for(int i = 0; i<a1.length; i++)
        {
        	for(int j = 0; j<a2.length;j++)
        	{
        		...
        		x3 = -(((a1[i]*(y2-y3)) + (a2[j]*(y3-y1)))/2);
        		insidea3 = binarySearch(a3, x3);
        		if(insidea3) 
        			{
        				System.out.println("Poop");
        				counter++;
 ...
 // ----------------------------------------------------------
     ...
     *
     *  Explanation: Due to its constantly dividing N in 2
     *
     */
